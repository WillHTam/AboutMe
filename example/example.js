...
.controller('console',['$scope','$ga','commandBroker','$rootScope', function ($scope, $ga, commandBroker, $rootScope, $http) {
    ...
    setTimeout(function () {
        $scope.$broadcast('terminal-output', {
            output: true,
            text: ['  A___A Welcome to WombatComputer-1',
                   ' ( o.o ) This is a live terminal about William Tam',
